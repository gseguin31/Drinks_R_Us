...
import com.example.a1507779.drinks_r_us.Adapters.MainActivity_DrinkAdapter;
...
public class MyFavs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView lvDrinks = (ListView)findViewById(R.id.lv_MyFavs);
        ...
        lvDrinks.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                DrinkDescIntent.putExtra("currentDrink", myFavsResult.get(position));
    ...
    private void refreshListView(List<Drinks> list){
        ListView lv = (ListView)findViewById(R.id.lv_MyFavs);
        adapter.clear();
        adapter.addAll(list);
